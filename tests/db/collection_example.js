...
var database_name = 'collection_test';
...
db.listDatabases()
  .then((names)=> {
    if (names.indexOf(database_name) > -1) {
      ...
      .then(()=>{
          return new Promise(function(resolve, reject) {
            db.collection('elements').remove('elements/s2')
            .then((res) => {
